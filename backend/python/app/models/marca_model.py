...
# 1. A Tabela Auxiliar (Associação N:N)
...
class MarcaModel(db.Model):
    ...
    # A MÁGICA: O SQLAlchemy vai gerenciar a tabela categorias_marcas sozinho!
    # O lazy="selectin" garante que as categorias sejam carregadas junto com a marca de forma otimizada.
    categorias = relationship("CategoriaModel", secondary=categorias_marcas_table, lazy="selectin")

    def to_entity(self) -> Marca:
        # Pega os IDs das categorias injetadas pelo SQLAlchemy e transforma na nossa lista de ints
